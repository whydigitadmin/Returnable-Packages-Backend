...
public class EmitterConstant {
	public static final String ISSUE_REQUEST_SUCCESS_MESSAGE = "Bin requested Successfully";
	public static final String ISSUE_REQUEST_REGISTERED_FAILED_MESSAGE = "Bin request Failed.";
