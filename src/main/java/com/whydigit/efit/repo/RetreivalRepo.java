...
public interface RetreivalRepo extends JpaRepository<RetreivalVO, Long> {
	...
	@Query(nativeQuery = true, value = "select b.category,b.assetcode,b.assetname,sum(b.outqty)outqty from gatheringempty a,gatheringemptydetails b \r\n"
			+ "			where a.gatheringemptyid=b.gatheringemptyid  and a.orgid=?1 \r\n"
