...
public interface BinAllotmentRepo extends JpaRepository<BinAllotmentVO, Long> {
	...
	@Query(nativeQuery = true, value = "select a.docid allotno,a.docdate allotdate,a.binreqno,a.binreqdate,c.address sender_address,c.city sender_city,c.state sender_state,c.gst sender_gst,d.name sender_name,e.legalname receiver_name from binallotment a, issuerequest b,warehouse c,\r\n"
	...
	@Query(nativeQuery = true, value = "select a.kitcode,a.allotkitqty,b.asset product_name,b.assetcode product_code,b.skuqty*a.allotkitqty product_qty from binallotment a, binallotment1 b where \r\n"
			+ "a.binallotmentid=b.binallotmentid and a.docid='24BA10000' \r\n"
