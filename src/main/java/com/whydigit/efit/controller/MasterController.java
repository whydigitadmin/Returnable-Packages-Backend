...
//	}
	...
	@GetMapping("/Tagcode")
	public ResponseEntity<ResponseDTO> getTagCodeByAsset(@RequestParam String assetcode, @RequestParam String asset, @RequestParam int endno,@RequestParam String category) {
